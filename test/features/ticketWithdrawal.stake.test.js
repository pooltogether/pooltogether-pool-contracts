  ...
  describe('instantly', () => {
    ...
    describe('with very large amounts', () => {
      ...
      it('should calculate correct exit-fees at 25%', async () => {
        await env.createPool({ prizePeriodSeconds: 10, creditLimit: '0.25', creditRate: '0.025', stakePool: true })
        await env.buyTickets({ user: 1, tickets: largeAmount })
      ...
      it('should calculate correct exit-fees at 37%', async () => {
        await env.createPool({ prizePeriodSeconds: 10, creditLimit: '0.37', creditRate: '0.037', stakePool: true })
        await env.buyTickets({ user: 1, tickets: largeAmount })
      ...
      it('should calculate correct exit-fees at 99%', async () => {
        await env.createPool({ prizePeriodSeconds: 10, creditLimit: '0.99', creditRate: '0.099', stakePool: true })
        await env.buyTickets({ user: 1, tickets: largeAmount })
