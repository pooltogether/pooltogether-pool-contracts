...
describe('External Awards', () => {
  ...
  it('should award external ERC20 tokens', async () => {
    await env.createPool({ prizePeriodSeconds: 10, exitFee: '0.1', creditRate: '0.01', externalERC20Awards: ['COMP'] })
  ...
  it('should award external ERC721 tokens', async () => {
    await env.createPool({ prizePeriodSeconds: 10, exitFee: '0.1', creditRate: '0.01', externalERC20Awards: [] })
