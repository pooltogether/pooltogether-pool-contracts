...
module.exports = function(deployer, networkName, accounts) {
  ...
  deployer.then(async () => {
    ...
    if (shell.exec(`zos create LotteryManager --init init --args ${accounts[0]},${moneyMarketAddress},${tokenAddress},${openDuration},${bondDuration},${ticketPrice},${feeFraction} --network ${networkName} --from ${process.env.ADMIN_ADDRESS}`).code !== 0) {
